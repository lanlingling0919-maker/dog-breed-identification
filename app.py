...
# 导入模型预测函数
from model_service import predict_dog
...
DOG_BREEDS_DICT = {
    ...
    "american_staffordshire_terrier": "美系斯塔福梗",
    "lhasa": "拉萨犬",
    "cardigan": "卡迪根柯基",
